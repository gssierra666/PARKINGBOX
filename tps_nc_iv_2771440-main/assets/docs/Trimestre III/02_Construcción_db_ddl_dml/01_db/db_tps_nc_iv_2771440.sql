...
CREATE TABLE IF NOT EXISTS `db_tps_nc_iv_2771440`.`USERS` (
  ...
  CONSTRAINT `fk_users_roles`
    ...
    REFERENCES `db_tps_nc_iv_2771440`.`ROLES` (`rol_code`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_tps_nc_iv_2771440`.`CUSTOMERS` (
  ...
  CONSTRAINT `fk_customers_users`
    ...
    REFERENCES `db_tps_nc_iv_2771440`.`USERS` (`user_code`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_tps_nc_iv_2771440`.`PRODUCTS` (
  ...
  CONSTRAINT `fk_products_categories`
    ...
    REFERENCES `db_tps_nc_iv_2771440`.`CATEGORIES` (`category_code`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_tps_nc_iv_2771440`.`ORDERS` (
  ...
  CONSTRAINT `fk_orders_customers`
    FOREIGN KEY (`customer_code`)
    REFERENCES `db_tps_nc_iv_2771440`.`CUSTOMERS` (`customer_code`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_tps_nc_iv_2771440`.`LIST_PRODUCTS_ORDERS` (
  ...
  CONSTRAINT `fk_list_products_orders`
    FOREIGN KEY (`order_code`)
    REFERENCES `db_tps_nc_iv_2771440`.`ORDERS` (`order_code`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_list_products_products`
    FOREIGN KEY (`product_code`)
    REFERENCES `db_tps_nc_iv_2771440`.`PRODUCTS` (`product_code`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
